# Necessary libary functions works on Python 2.7.12. Here skelearn is used on iris dataset to show the function of the backward feature selection algorithm .
