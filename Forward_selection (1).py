# Necessary libary functions are used. Here skelearn is used on Group Project test and train dataset to show the function of the forward feature selection algorithm .
...
def reducer_svm_forward(X, y, n_selected_features):
    ...
    # similarly other algorithms like Decision Tree, Naive Bayes and Logistic regression can also be used to do the same,
