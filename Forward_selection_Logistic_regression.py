# Necessary libary functions are used. Here skelearn is used on our Group Project test and train dataset to show the function of the forward feature selection algorithm .
        ...
        for i in range(n_features):
            if i not in sub_set:
                ...
                # here we used a threshold of 0.03 to maintain the accuracy within a limit, 
                    # without that value the obtained subset of features will give the maximum accuracy which is equivalent to the 
